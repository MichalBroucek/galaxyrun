...
class Rocks_edges(Obstacles):
    ...
    def __init__(self, flight_speed=13):
        super(Rocks_edges, self).__init__(speed=flight_speed, picture_src='pictures/square_4.png', offset_positions=INITIAL_POS_OFFSETS,
    ...
    def add_all_to_widget(self, destination_widget):
        ...
        for index, pos in enumerate(self.initial_pos_offset_with_flags):
            ...
            if pos[2] == 'R':
                ...
                # rock_x_size = x_orig_position + rock_x_size
                # rock_x_pos = 0 ... for all right edges positions
